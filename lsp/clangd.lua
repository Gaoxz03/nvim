...
---@type vim.lsp.Config
return {
    cmd = {'clangd', "--background-index=false", "--pch-storage=memory", 
           "--all-scopes-completion=true", "--clang-tidy", "--completion-style=detailed"},
    filetypes = {'c', 'cpp', 'objc', 'objcpp', 'cuda', 'cc', 'h', 'hpp', 'hip'},
